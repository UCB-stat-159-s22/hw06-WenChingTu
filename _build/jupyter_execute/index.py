...
from utils import whiten, write_wavfile, reqshift, plot_det
...
for det in dets:
    ...
    plot_det(make_plots,det,time,timemax,SNR,template_match,eventname,plottype,tevent,template_fft,strain_L1_whitenbp,datafreq,d_eff,freqs,data_psd,strain_H1_whitenbp,fs)
